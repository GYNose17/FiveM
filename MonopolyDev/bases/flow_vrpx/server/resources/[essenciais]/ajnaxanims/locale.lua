...
locale['en'] = {
	...
	request_prompt    = '~r~%s~s~ | ~r~%s~s~  Accept or decline %s',
	...
	anim_03 = 'Blowjob %s',
	anim_04 = 'Blowjob 2 %s',
	anim_05 = 'Atenas Position %s',
	anim_06 = 'Inverted Atenas Position %s',
...
locale['br'] = {
	...
	request_prompt    = '~r~%s~s~ | ~r~%s~s~  Aceitar ou recusar %s',
