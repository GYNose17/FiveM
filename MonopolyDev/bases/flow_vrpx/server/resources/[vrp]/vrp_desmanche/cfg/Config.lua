Config = {
    webhookdesmanche = "https://discord.com/api/webhooks/1111817122667053087/xN12OTRt22jW18K5dlDQ65R6c1JL2JFCxpLIQTp8Xls7e_Fr3OP4bk_Vbeprd7VNJpah", -- Link do webhook
    ...
    itens_extra = {
        ...
        [1] = { ['nome'] = "discofreio", ['valor'] = 500 },
        [2] = { ['nome'] = "parachoque", ['valor'] = 500 },
        [3] = { ['nome'] = "volante", ['valor'] = 500 },
        [4] = { ['nome'] = "motorcarro", ['valor'] = 500 },

        -- RESTANTE PARA MOTOS
        [5] = { ['nome'] = "motormoto", ['valor'] = 500 },
