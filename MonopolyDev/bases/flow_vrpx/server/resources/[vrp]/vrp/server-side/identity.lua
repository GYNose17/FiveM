...
-- FUNCTIONS
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function vRP.getUserIdentity(user_id,force)
	if user_id then
		if cache['getUserIdentity'][user_id] == nil or force then
...
AddEventHandler("vRP:playerSpawn",function(user_id, source, first_spawn)
	...
	if identity then
		vRPclient._setRegistrationNumber(source,identity.registration or "DDDDDD")
	end
end)
