...
cfg.items = {
	...
	--Colete
	["kevlar"] = { "Kevlar", "none", 1.0, nil, nil},
	["pano"] = { "Pano", "none", 1.0, nil, nil},
	["linha"] = { "Linha", "none", 1.0, nil, nil},	

	--Desmanche
	["rodacarro"] = { "Roda de Carro", "none", 0.3, nil, nil},
	["portacarro"] = { "Porta de Carro", "none", 0.3, nil, nil},
	["rodamoto"] = { "Roda de Moto", "none", 0.3, nil, nil},
	["discofreio"] = { "Disco de Freio", "none", 0.3, nil, nil},
	["parachoque"] = { "Parachoque", "none", 0.3, nil, nil},
	["volante"] = { "Volante", "none", 0.3, nil, nil},
	["motorcarro"] = { "Motor de Carro", "none", 0.3, nil, nil},
	["motormoto"] = { "Motor de Moto", "none", 0.3, nil, nil},
