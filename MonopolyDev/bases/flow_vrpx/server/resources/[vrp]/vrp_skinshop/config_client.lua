...
Config_client = {
    ...
    texto = "~g~[E]~w~ ~b~Loja de roupas", -- Texto 3d q aparecerá
    ...
    url = "http://104.234.65.51/ultimate/roupas/", -- Url das suas imagens do xampp
    ...
    lojaderoupa = {
        ...
        { name = "Loja de Roupas", x = -443.57, y = -313.5, z = 34.91},-- hospítal -443.57,-313.5,34.91
        { name = "Loja de Roupas", x = 1707.77, y = 1038.25, z = 160.03},
        { name = "Loja de Roupas", x = 2746.82, y = 3500.33, z = 61.3}, --Mecanica 2746.82,3500.33,61.3
       ...
       -- { name = "Loja de Roupas", x = 213.83, y = -895.11, z = 31.64, provador = {x = 213.83, y = -895.11, z = 31.64, heading = 186.52}}, ---dentro da praça  213.83,-895.11,31.64
