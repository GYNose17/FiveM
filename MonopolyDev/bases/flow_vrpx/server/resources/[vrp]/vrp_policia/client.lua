...
function src.enviarIdentidade(status, id, nome,sobrenome,idade,registro,telefone,carteira,trabalho)
    if status then
        local html = string.format("<div id='simplehud'> <div class='label_carteira'><img src='' style='width: 120px;'></div> <div class='info_carteira'> <div class='info_section'> PASSAPORTE: <span class='info'>"..id.."</span> </div> </div> <div class='info_carteira'> <div class='info_section'> NOME: <span class='info'> "..nome.. " "..sobrenome.. " ("..idade..")</span> </div> </div> <div class='info_carteira'> <div class='info_section'> RG: <span class='info'> "..registro.. "</span> </div> </div> <div class='info_carteira'> <div class='info_section'> Telefone: <span class='info'> "..telefone.. "</span> </div> </div> <div class='info_carteira'> <div class='info_section'> Trabalho: <span class='info'> "..trabalho.. "</span> </div> </div> <div class='info_carteira'> <div class='info_section'> Carteira: <span class='info'> "..carteira.. "</span> </div> </div> </div>")
...
function src.checkPrisonArea()
    ...
    local _,i = GetGroundZFor_3dCoord(832.07,154.3,82.29)
    local distance = Vdist(x,y,z,832.07,154.3,82.29,i)
...
function src.levarPrisioneiro(prisionTime)
	...
	if HasModelLoaded(vhash) then
		nveh = CreateVehicle(vhash, 809.52,171.53,81.15,333.03,true,false)
...
RegisterNetEvent("flow_survival:updateArena")
AddEventHandler("flow_survival:updateArena", function(boolean)
    in_arena = boolean
end)
