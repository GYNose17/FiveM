			...
			if not servico then
				...
				if distance2 <= 2.0 then
					...
					if IsControlJustReleased(1, 51) and segundos <= 0 then
						segundos = 5
						criarVehicle(61.0,124.57,79.13,161.27,"speedo", false)
					end
				end
				...
				if distance3 <= 2.0 then
					...
					DrawMarker(2,v.pegarcaixas[1],v.pegarcaixas[2],v.pegarcaixas[3]-0.20, 0,0, 0,0, 0,0, 0.5, 0.4, 0.5, 229, 35, 149, 80, 1, 0, 0, 0)
					if IsControlJustReleased(1, 51) and segundos <= 0 then
						segundos = 5
