...
nation_skinshop = true -- deixe true caso use o script nation_skinshop 93.22, -853.58, 31.05
...
maxHealth = 301 -- vida máxima do player
...
resetCloths = function()
    local clothes = {
        [GetHashKey("mp_m_freemode_01")] = {
            ...
            ["bodyArmors"] = { 0, 0, 0 },    --colete
            ["torsos"] = { 15, 0, 2 },       --maos
            ["accessories"] = { -1, 0, 2 },  --acessorios
            ["hats"] = { -1,0 },             --chapeu
            ["masks"] = { 0,0,0 },           --mascara
            ["undershirts"] = { 15, 0, 2 },  --blusa
            ["shoes"] = { 34, 0, 2 },        --sapato
            ["bracelets"] = { -1,0 },
            ["tops"] = { 15, 0, 2 },         
            ["bags"] = { 0,0,0 },       
        ...
        [GetHashKey("mp_f_freemode_01")] = {
            ...
            ["hats"] = { -1,0 },                --chapeu
            ["masks"] = { 0,0,0 },              --mascara
            ["undershirts"] = { 14, 0, 2 },     --blusa
            ["shoes"] = { 35, 0, 2 },           --sapato
            ["bracelets"] = { -1,0 },           --pulso
            ["tops"] = { 15, 0, 2 },            --jaqueta
            ["bags"] = { 0,0,0 },               --mochila
            ["ears"] = { -1,0 },                --brincos
            ["decals"] = { 0,0,0 },             --adesivos
            ["legs"] = { 15, 0, 2 },            --calca
            ["watches"] = { -1,0 },             --relogio
            ["glasses"] = { -1,0 },             --oculos
        },
...
setCloths = function()
    local clothes = {
        ...
        [GetHashKey("mp_f_freemode_01")] = {
            ...
            ["bodyArmors"] = { 0, 0, 0 },          --colete
            ["torsos"] = { 14, 0, 2 },             --maos
            ["accessories"] = { 0, 0, 2 },         --acessorios
            ["hats"] = { -1,0 },                   --chapeu
            ["masks"] = { 0,0,0 },                 --mascara
            ["undershirts"] = { 6, 0, 2 },         --blusa
            ["shoes"] = { 49, 0, 2 },              --sapato
            ["bracelets"] = { -1,0 },              --pulso
            ["tops"] = { 338, 7, 2 },              --jaqueta
            ["bags"] = { 0,0,0 },                  --mochila
            ["ears"] = { -1,0 },                   --brincos
            ["decals"] = { 0,0,0 },                --adesivos
            ["legs"] = { 112, 0, 2 },              --calca
...
RegisterCommand('testecreator', function()
    initCreator()
end)
...
function setGender(gender)    
    ...
    TriggerEvent("zeiraboy",currentArmour)
...
spawns = {
    { name = "Garagem Praça", coords = {212.18,-808.08,30.83,176.39} },
