...
vRPserver = Tunnel.getInterface("vRP","flow_survival")

src = {}
Tunnel.bindInterface("flow_survival",src)

vSERVER = Tunnel.getInterface("flow_survival") 
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
cfg = {}

cfg.versionNUI = false -- Tela de Morte Versão com NUI
cfg.deathNUItimer = 0 -- Tempo de morte que o jogador vai conseguir utilizar o botao de desistir imediatamente
cfg.deathtimer = 500 -- Tempo in coma
cfg.minHealth = 101 -- o Minimo de vida do seu servidor
cfg.maxHealth = 300 -- o máximo de vida do seu servidor
cfg.cooldown = 60 -- Delay por pessoa, para evitar FLOODS de Logs no DISCORD [ OBS: Deixar sempre maior que 10 ]
cfg.respawn = vec3(1151.35,-1529.59,35.37) -- Localização quando o jogador respawnar
