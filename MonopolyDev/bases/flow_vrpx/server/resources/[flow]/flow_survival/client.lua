	...
	while true do
        ...
        if cfg.dependencys() then
            ...
            if vida <= cfg.minHealth and not morto then
                ...
                TriggerEvent('flow_survival:updateComa', morto)
...
RegisterNetEvent("flow_survival:updateComa")
...
RegisterNetEvent("flow_survival:updateTime")

AddEventHandler("flow_survival:updateTime", function(time) 
...
RegisterNetEvent("flow_survival:setHud")

AddEventHandler("flow_survival:setHud", function(boolean) 
