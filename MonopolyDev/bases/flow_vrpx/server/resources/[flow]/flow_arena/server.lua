    ...
    if flow_auth then
        ...
        if source then
            ...
            SetTimeout(5000,function()
                if source then
                    TriggerClientEvent('flow_survival:updateArena', source, false)
                    inArena[user_id] = nil
                end
            end)
        end
