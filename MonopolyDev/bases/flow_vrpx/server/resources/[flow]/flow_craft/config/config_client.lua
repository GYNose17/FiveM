...
vRPserver = Tunnel.getInterface("vRP","flow_craft")

src = {}
Tunnel.bindInterface("flow_craft",src)
vSERVER = Tunnel.getInterface("flow_craft")
...
config.imgDir = "http://104.234.65.51:/ultimate/inventario/" -- DIRETORIO DE SUAS IMAGENS
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- TRADUÇOES
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
config.lang = {
