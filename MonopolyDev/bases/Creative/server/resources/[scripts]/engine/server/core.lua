...
-----------------------------------------------------------------------------------------------------------------------------------------
Baixada = {}
Tunnel.bindInterface("engine", Baixada)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local Brakes = {}
...
-- RECHARGEFUEL
-----------------------------------------------------------------------------------------------------------------------------------------
function Baixada.RechargeFuel(Price)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
		if vRP.PaymentFull(Passport,Price) then
			if NewBankTaxs then
				exports["bank"]:AddTaxs(Passport,"Posto de Gasolina",Price * 0.4,"Gastos com combustível.")
			end
...
-- VEHICLEBRAKES
-----------------------------------------------------------------------------------------------------------------------------------------
function Baixada.VehicleBrakes(Vehicle)
