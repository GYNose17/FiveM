...
-----------------------------------------------------------------------------------------------------------------------------------------
Baixada = {}
Tunnel.bindInterface("player", Baixada)
...
RegisterCommand("fps", function()
	if UseFps then
		...
		TriggerEvent("Notify","default","Sistema desativado.","Otimização",5000)
	else
		UseFps = true
		...
		TriggerEvent("Notify","default","Sistema ativado.","Otimização",5000)
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADROPE
...
-- REMOVEVEHICLE
-----------------------------------------------------------------------------------------------------------------------------------------
function Baixada.RemoveVehicle()
...
-- PLACEVEHICLE
-----------------------------------------------------------------------------------------------------------------------------------------
function Baixada.PlaceVehicle(Network)
...
AddEventHandler("player:enterTrunk",function(Entity)
	if not inTrunk and GetVehiclePedIsEntering(PlayerPedId()) == 0 then
