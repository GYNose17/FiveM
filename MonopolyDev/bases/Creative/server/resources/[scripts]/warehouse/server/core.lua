...
-----------------------------------------------------------------------------------------------------------------------------------------
Baixada = {}
Tunnel.bindInterface("warehouse",Baixada)
...
-- WAREHOUSE
-----------------------------------------------------------------------------------------------------------------------------------------
function Baixada.Warehouse(Name)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
					...
					if string.len(Password) >= 4 and string.len(Password) <= 20 then
						if vRP.Request(source,"Armazém","Finalizar a compra usando a senha <b>"..Password.."</b>?") then
							if vRP.PaymentFull(Passport,500000) then
								...
								if NewBankTaxs then
									exports["bank"]:AddTaxs(Passport,"Prefeitura",500000 * 0.2,"Compra de armazém.")
								end
...
-- STORE
-----------------------------------------------------------------------------------------------------------------------------------------
function Baixada.Store(Item,Slot,Amount,Target,Name)
	local source = source
...
-- TAKE
-----------------------------------------------------------------------------------------------------------------------------------------
function Baixada.Take(Item,Slot,Amount,Target,Name)
	local source = source
	local Amount = parseInt(Amount,true)
	local Passport = vRP.Passport(source)
	if Passport then
...
-- UPDATE
-----------------------------------------------------------------------------------------------------------------------------------------
function Baixada.Update(Slot,Target,Amount,Name)
	local source = source
	local Amount = parseInt(Amount,true)
	local Passport = vRP.Passport(source)
	if Passport then
