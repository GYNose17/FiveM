...
-----------------------------------------------------------------------------------------------------------------------------------------
Baixada = {}
Tunnel.bindInterface("trucker",Baixada)
...
AddEventHandler("trucker:Vehicles",function()
	if not Package then
		...
		Package = true
		Service = "Vehicles"
		TriggerEvent("Notify","amarelo","Dirija-se ao caminhão e buzine o mesmo<br>para receber a carga responsável pelo transporte.","Atenção",5000)
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- TRUCKER:DIESEL
