...
AddEventHandler("vRP:Active", function(Passport, Name)
	SetDiscordAppId()
	SetDiscordRichPresenceAsset("baixada-asset")
	SetRichPresence("#"..Passport.." "..Name)
	SetDiscordRichPresenceAssetSmall("baixada")
	SetDiscordRichPresenceAssetText("Baixada RP")
	SetDiscordRichPresenceAssetSmallText("Baixada RP")
